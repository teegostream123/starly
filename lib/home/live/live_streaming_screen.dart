...
<<<<<<< HEAD
    _engine.registerEventHandler(RtcEngineEventHandler(
      ...
      onEncryptionError: (connection, errorType) {
        print("onEncryptionError $connection $errorType");
      },
...
<<<<<<< HEAD
  ...
  Future<void> _initAgoraRtcEngine() async {
    try {
      ...
      await _engine
          .initialize(RtcEngineContext(appId: Config.agoraAppId))
          .catchError((error, trace) {
        print(["init error", error]);

        print(['init stack tracee', trace]);
      });

      print("preference print here testing ${widget.preferences}");
      if (isBroadcaster || isUserInvited) {
        await _engine.startPreview().onError((error, stackTrace) {
          print([
            "error",
            error,
          ]);
